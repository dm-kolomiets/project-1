    ...
    <div class="col-sm-5 col-xl-4 col-xxl-auto">
      <div class="footer-item first">
        ...
        <div class="footer-content custom_offset">
          <div class="text">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto aut dicta modi consequatur quo sit harum, perspiciatis optio. Dicta, quas.
            </p>
          </div>
          <a href="mailto:info@lorem.com" class="btn-link">info@lorem.com</a>
        </div>
      </div>
    </div>
    <div class="col-sm-6 col-xl-4 col-xxl-auto">
      <div class="footer-item">
        <div class="caption h5">Lorem Links</div>
    ...
    <div class="col-sm-6 col-xl-4 col-xxl-auto">
      <div class="footer-item last">
        ...
        <div class="footer-content custom_offset">
          <div class="text">
            <p>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repellat accusantium corporis impedit.
            </p>
          </div>
...
<div class="footer_bottom">
  <div class="banner-align">
    <div class="bg" style="background-image: url('img/footer-decor.png')"></div>
    <div class="bg mobile" style="background-image: url('img/footer-decor.png')"></div>
  </div>
</div>